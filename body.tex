...
\begin{lemma} (Main Lemma: Skein Construction of Balanced Tensor Product) \label{lemma/main-lemma}
...
\begin{proof}
  ...
  The second part follows directly from induction and the first part.
\end{proof}

% TODO Add a theorem about effects of induced functors.
