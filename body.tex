...
The main theorem presented in this paper aligns with expectations held by many
(mathematical) physicists. However, to the best of our knowledge, it has not
...
\begin{definition}\label{definition/skein-category} (Skein Category)
  ...
  \]
  [TODO. Add a picture for a typical skein in this generalization.]
\end{definition}
...
\begin{proof}
  ...
  completion (in which objects must be ``absorbed'' into morphism). [TODO: add
  a picture this proof, especially the part that uses the (co)unit maps.].
\end{proof}
